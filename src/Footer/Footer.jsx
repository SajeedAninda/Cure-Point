...
const Footer = () => {
  return (
    <div className='bg-slate-200'>
      <div className='w-[90%] lg:w-[1150px] mx-auto py-20 grid grid-cols-2 lg:grid-cols-4 gap-12'>
        <div>
        ...
        <div>
          <h3 className='text-[#1e1e1e] font-bold text-[20px]'>Quick Links</h3>
          <div className='mt-5'>
        ...
        <div>
          <h3 className='text-[#1e1e1e] font-bold text-[20px]'>Doc House Services</h3>
          <div className='mt-5'>
            <li className='hover:opacity-70 transition-opacity text-[18px] font-medium duration-300 ease-in-out cursor-pointer list-none hover:underline text-gray-500'>
              Pediatric Clinic
            </li>
        ...
        <div>
          <h3 className='text-[#1e1e1e] font-bold text-[20px]'>Working Hours</h3>
          <div className='mt-5'>
            <li className='hover:opacity-70 transition-opacity text-[18px] font-medium duration-300 ease-in-out cursor-pointer list-none hover:underline text-gray-500'>
              Monday. 10am - 7am
            </li>
